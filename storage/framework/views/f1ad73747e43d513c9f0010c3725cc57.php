    ...
    <div class="split-layout">
        ...
        <div class="left-side">
            <div class="logo-container">
                ...
                <img src="<?php echo e(asset('image/qwetu_link_pos.png')); ?>" alt="Qwetu Link POS" />
            </div>
        </div>
...
<?php echo $__env->make('layouts.auth.login', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\qwetu_links_pos\resources\views/auth/login.blade.php ENDPATH**/ ?>