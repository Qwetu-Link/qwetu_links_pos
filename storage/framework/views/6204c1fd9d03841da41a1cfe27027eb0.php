    ...
    <div class="navbar">
        <div class="container">
            ...
            <div class="nav-links">
                ...
                <a href="<?php echo e(route('login')); ?>" class="btn-outline">Login / Sign Up</a>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\qwetu_links_pos\resources\views/welcome.blade.php ENDPATH**/ ?>