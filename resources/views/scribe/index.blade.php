...
<head>
    ...
    <title>Qwetu Link POS API Documentation</title>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>http://reynolds.com/</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="color[0]"                data-endpoint="POSTapi-v1-products"
               data-component="body">
        <input type="text" style="display: none"
               name="color[1]"                data-endpoint="POSTapi-v1-products"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="size[0]"                data-endpoint="POSTapi-v1-products"
               data-component="body">
        <input type="text" style="display: none"
               name="size[1]"                data-endpoint="POSTapi-v1-products"
               data-component="body">
    <br>
<p>Must not be greater than 20 characters.</p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>buy_price</code></b>&nbsp;&nbsp;
<small>number[]</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="buy_price[0]"                data-endpoint="POSTapi-v1-products"
               data-component="body">
        <input type="number" style="display: none"
               name="buy_price[1]"                data-endpoint="POSTapi-v1-products"
               data-component="body">
    <br>
...
<small>number[]</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="instock[0]"                data-endpoint="POSTapi-v1-products"
               data-component="body">
        <input type="number" style="display: none"
               name="instock[1]"                data-endpoint="POSTapi-v1-products"
               data-component="body">
    <br>
<p>Must be at least 0.</p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>sell_price</code></b>&nbsp;&nbsp;
<small>number[]</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="sell_price[0]"                data-endpoint="POSTapi-v1-products"
               data-component="body">
        <input type="number" style="display: none"
               name="sell_price[1]"                data-endpoint="POSTapi-v1-products"
               data-component="body">
    <br>
<p>Must be at least 0.</p>
        </div>
...
<small>string[]</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="product_id[0]"                data-endpoint="POSTapi-v1-products"
               data-component="body">
        <input type="text" style="display: none"
               name="product_id[1]"                data-endpoint="POSTapi-v1-products"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the product_catalogs table.</p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/products/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/products/consequatur"
);
